...
public class ProxyMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    @Override
    protected ProxyEntity decode(ChannelHandlerContext ctx, ByteBuf in2) throws Exception {
        ...
        proxyMessage.setType(in.readByte());
        proxyMessage.setSerialNumber(in.readInt());
