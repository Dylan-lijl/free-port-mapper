...
public class CommonResult<T> {
    ...
    public static <T> CommonResult<T> successCreate() {
        return successCreate(null);
    }

    public static <T> CommonResult<T> successCreate(T data) {
        return new CommonResult<T>(ResultCodeEnum.SUCCESS_CREATE.getCode(), ResultCodeEnum.SUCCESS_CREATE.getMessage(), data);
    }
    ...
    public static <T> CommonResult<T> successUpdate(T data) {
        return new CommonResult<T>(ResultCodeEnum.SUCCESS_UPDATE.getCode(), ResultCodeEnum.SUCCESS_UPDATE.getMessage(), data);
    }
    ...
    public static <T> CommonResult<T> successDelete(T data) {
        return new CommonResult<T>(ResultCodeEnum.SUCCESS_DELETE.getCode(), ResultCodeEnum.SUCCESS_DELETE.getMessage(), data);
    }
